...
public class Industry {
	...
	private String scJyAddressXingZhi; //生产经营场所性质
	private String jyTime;		//经营时间
	private String addressArea;  //生产经营场所面积
	private String processArea;	//食品处理区面积
	private String market;		//销售方式
	private String zuoWeiNum;     //小餐饮店就餐座位数
	private String shiFoSongCan;   //是否送餐
	private String shiDuanXingZhi; //生产经营时段性质
	private String studentNum;	//小餐桌就餐座位数
	...
	public String getScJyAddressXingZhi() {
		return scJyAddressXingZhi;
	}

	public void setScJyAddressXingZhi(String scJyAddressXingZhi) {
		this.scJyAddressXingZhi = scJyAddressXingZhi;
	}
	...
	public String getZuoWeiNum() {
		return zuoWeiNum;
	}

	public void setZuoWeiNum(String zuoWeiNum) {
		this.zuoWeiNum = zuoWeiNum;
	}

	public String getShiFoSongCan() {
		return shiFoSongCan;
	}

	public void setShiFoSongCan(String shiFoSongCan) {
		this.shiFoSongCan = shiFoSongCan;
	}

	public String getShiDuanXingZhi() {
		return shiDuanXingZhi;
	}

	public void setShiDuanXingZhi(String shiDuanXingZhi) {
		this.shiDuanXingZhi = shiDuanXingZhi;
	}
