...
<head>
   ...
   <script type="text/javascript">
                  ...
                  <table id="" class="table table-condensed" >                   
                    <tbody>
                     <tr>
                      ...
                      <input id="dwname" type="text" onfocus="loadXMLDoc(this.value)" style="width:280px" class="" name="dwname" />                
                      
                    
                      </td> 
                      <td><b>2.抽检时间</b></td>
                     <td><input id="cjsj" type="text" style="width:280px" class="" name="cjsj" /></td> 
                     </tr>
                     <script type="text/javascript"> 
    ...
    function loadXMLDoc(str) { 
        ...
        xmlhttp.open("GET", "FoodAjaxServlet?dwname="+str, true); 
        ...
        oo.Create(document.getElementById('dwname')); 

    </script>
                     <tr>
                     	<td>请选择表：</td>
                     	<td><select id="table" style="width:280px" name="table" onchange="changeFunc();">
